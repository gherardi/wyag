...
class GitRepository (object):
    ...
    def __init__(self, path, force=False):
        ...
        # if we are not in a test mode (force), or we're not in a directory, raise an exception
